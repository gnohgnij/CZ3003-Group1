...
public class CreateChallengeController : MonoBehaviour
{
    ...
    {
        StartCoroutine(Submit_Challenge(DDInputField.text, MMInputField.text, YYYYInputField.text, hhInputField.text, mmInputField.text, ssInputField.text, emailField.text, opponentEmailField.text));
    }
